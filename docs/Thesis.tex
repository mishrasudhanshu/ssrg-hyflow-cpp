...
In Figure~\ref{Fig:flatSkipList}, we can observer.
...
In Figure~\ref{Fig:flatBst}, we can observer.
...
We perform our experiments on Bank, Linked List, Skip-list, Hash-table and BST. We present our results for all three experiments for each benchmark.
