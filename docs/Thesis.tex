...
\begin{figure}[H]
\centering
\subfigure[Bank with constant Objects]{
...
\begin{figure}[H]
\centering
\subfigure[Bank with increasing Objects]{
...
\begin{figure}[H]
\centering
\subfigure[Bank with decreasing granularity]{
\includegraphics[width=0.7\textwidth]{\string"eps/checkpointing/bank/Ex2/r20".pdf}
\label{Fig:cpBankEx3}
}
...
In Figure~\ref{Fig:cpList}

\begin{figure}[H]
\centering
\subfigure[Linked List with constant Objects]{
...
\begin{figure}[H]
\centering
\subfigure[Linked List with increasing Objects]{
...
\caption{Close Nesting and Checkpointing: Relative Transactional throughput for Linked List}
\label{Fig:cpList}
\end{figure}
...
\begin{figure}[H]
\centering
\subfigure[Skip-list with constant Objects]{
...
\begin{figure}[H]
\centering
\subfigure[Skip-list with increasing Objects]{
...
\begin{figure}[H]
\centering
\subfigure[Skip-list with decreasing granularity]{
\includegraphics[width=0.7\textwidth]{\string"eps/checkpointing/skiplist/Ex1/r20".pdf}
\label{Fig:cpSkiplistEx3}
}
\caption{Close Nesting and Checkpointing: Relative Transactional throughput for Skip-list}
...
\begin{figure}[H]
\centering
\subfigure[Hash-table with constant Objects]{
...
\caption{Close Nesting and Checkpointing: Relative Transactional throughput for Hash-table}
