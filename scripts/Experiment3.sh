...
# In this experiment, we reduce the inner trxn graunarity 
...
do
    ...
    do
        ...
        do
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            benchmark=$bench ITCPR=$itcpr nestingModel=$model innerTxns=$inTxns nodes=$nodes objects=$objs transactions=$txns nodeId=$nodeId reads=$read threads=$threads $build/ssrg-hyflow-cpp $nodeId -&
            ...
            mv log "$bench"_exp3/log_"$model"_ITCPR_"$itcpr"
        done
    done
