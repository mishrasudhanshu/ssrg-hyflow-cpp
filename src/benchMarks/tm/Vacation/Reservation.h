...
public:
	...
	ReservationArgs(int m, std::string i1, std::string i2) {
		money= m;
		id1 = i1;
		id2 = i2;
	}
...
class Reservation: public HyflowObject {
...
public:
	Reservation() {};
	Reservation(uint64_t amount, const std::string & Id);
	Reservation(uint64_t amount, const std::string & Id, int version);
	virtual ~Reservation();
